var seoObject = [
    ...
    },
    {
        "@context": "https://schema.org",
        "@type": "SoftwareApplication ",
        "name": "DirectionAL Drilling Calculator",
        "operatingSystem": ["WINDOWS", "OSX"],
        "applicationCategory": ["DeveloperApplication", "EducationalApplication"],
        "author": {
            "@type": "Person",
    ...
    },
    {
        "@context": "https://schema.org",
        "@type": "SoftwareApplication ",
        "name": "TextWriter Demo",
        "operatingSystem": ["WINDOWS", "OSX"],
        "applicationCategory": ["DeveloperApplication", "EducationalApplication", "UtilitiesApplication"],
        "author": {
            "@type": "Person",
            "givenName": "Nathaniel",
            "familyName": "Cobbinah",
